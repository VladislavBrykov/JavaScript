function db_new_like(post_id, id_user, comment_id, type_role) {
    ...
    return new Promise((resolve, reject) => {
        ...
        let str = [id_user, type_role, post_id]
        const sqll = `SELECT id FROM likes WHERE id_user = ? AND type_role = ? AND post_id = ?`;
